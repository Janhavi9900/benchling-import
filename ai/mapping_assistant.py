...
def mock_claude_suggest(benchling_fields: list, uploaded_columns: list, schema_name: str) -> list:
    ...
    keyword_map = {
        ...
        "barcode":            ("Sample_ID",          90, "Barcode → Sample_ID (unique container barcode)"),
        "entity_linked":      (None,                  0, "Resolved at runtime — linked to created DNA ID"),
        "entity linked":      (None,                  0, "Resolved at runtime — linked to created DNA ID"),
        "linked_sample":      (None,                  0, "Resolved at runtime — linked to created sample ID"),
