    ...
    <div>
      <div style={{marginBottom:20}}>
        ...
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
          ...
          <Btn color={C.purple} onClick={downloadPDF} tooltip="Download as PDF">⬇ Download PDF</Btn>
        </div>
      </div>
      ...
      <div style={{display:"flex",gap:8,justifyContent:"flex-end",marginTop:16}}>
        <Btn ghost color={C.purple} onClick={downloadPDF}>⬇ PDF</Btn>
        <Btn ghost color={C.cyan}
          onClick={()=>fetch(`${API}/api/mapping/download`).then(r=>r.blob()).then(b=>{
            const u=URL.createObjectURL(b); const a=document.createElement("a");
            a.href=u; a.download="approved_mapping.json"; a.click();
          })}>⬇ Mapping</Btn>
